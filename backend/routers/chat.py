...
from schemas.chat_schema import ChatRequestInput, ChatRequestOut, ChatRequestAction
...
async def create_chat_request(
    ...
    request_out = ChatRequestOut.model_validate(request)
    await manager.send_1_to_1("chat.request_received", current_user.user_id, body.target_id, request_out)
