...
const handleAddCert = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.detail || "Server báo lỗi nhưng không có 'detail'");
      }
          ...
          <form onSubmit={handleProfileSubmit}>
            ...
            {isCoacher && (
                <div className="md:col-span-2">
                    <label htmlFor="introduction_text" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            {/* ... (input URL Ảnh đại diện) ... */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.full_name} onChange={handleProfileChange}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-400"
                  />
                </div>
                {/* Nghề nghiệp */}
                <div>
                  ...
                  <input
                    ...
                    value={formData.job} onChange={handleProfileChange}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-400"
                  />
                </div>
                {/* Số điện thoại */}
              ...
              <div>
                ...
                <input
                  type="text" name="avatar_url" id="avatar_url"
                  value={formData.avatar_url} onChange={handleProfileChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-400"
                />
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-3">
            {certificates.length > 0 ? (
              ...
              <p className="text-gray-500 text-center py-4">Bạn chưa thêm bằng cấp nào.</p>
            )}
          </div>
          ...
          <form onSubmit={handleAddCert}>
            <div className="border-t border-gray-200 dark:border-gray-700 p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={newCert.title} onChange={handleCertChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-400"
              ...
              <div>
                ...
                <input
                  ...
                  value={newCert.image_url} onChange={handleCertChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-400"
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 px-6 py-4 text-right">
              <button
                type="submit" disabled={savingCert}
